...
- 原项目地址
  - 官网 https://idle-xiuxian.wenzi.games/
  - GitHub仓库 https://github.com/setube/vue-idle-xiuxian
- 我汉化和构建docker镜像的仓库
  - GitHub仓库 https://github.com/Firfr/idle-xiuxian
  - Gitee仓库 https://gitee.com/firfe/idle-xiuxian


如果镜像拉取失败，请B站发私信，或提issues，华为云上的镜像仓库默认推送的镜像不是公开的，有可能是我忘记设置公开了。

当前制作镜像版本(或截止更新日期)：1.0.5之后 2025年09月29日

首先感谢原作者的开源。  
原项目的docker镜像有450M左右，我对镜像制作流程做了优化，重新制作了镜像，镜像大小只有1.5M左右。
...
容器内部端口`5152`，可通过设置启动参数的值来指定监听端口。

- AMD64镜像
  ```bash
  swr.cn-north-4.myhuaweicloud.com/firfe/idle-xiuxian:1.0.5
  ```
- ARM64镜像
  ```bash
  swr.cn-north-4.myhuaweicloud.com/firfe/idle-xiuxian:1.0.5-arm64
  ```
...
services:
  idle-xiuxian:
    container_name: idle-xiuxian
    image: swr.cn-north-4.myhuaweicloud.com/firfe/idle-xiuxian:1.0.5
    network_mode: bridge
    restart: always
    logging:
      options:
